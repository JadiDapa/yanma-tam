...
import { CreateHandoverSchema } from "@/server/validators/handover.validator";
import { createHandover } from "@/app/actions/handover.action";

type HandoverFormType = z.infer<typeof CreateHandoverSchema>;

export default function CreateHandoverDialog() {
  const [open, setOpen] = useState(false);
  const [isPending, startTransition] = useTransition();

  const form = useForm<HandoverFormType>({
  ...
  async function onSubmit(values: HandoverFormType) {
